...
CK_RV ExportBIP32ExtendKey(struct ctx * c, CK_SESSION_HANDLE session, CK_OBJECT_HANDLE key, CK_CHAR_PTR encodedKeyPtr, CK_ULONG_PTR ulSize)
{
  ...
  //memcpy(encodedKeyPtr, encodedKey, ulEncodedKeySize);
  return e;
}
*/
import "C"
